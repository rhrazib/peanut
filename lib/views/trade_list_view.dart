  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<TradeModel>>(
        future: tradesController.getUserTrades(authController.accessToken.value, authController.authModel.login),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return RefreshIndicator(
              onRefresh: () async {
                await tradesController.getUserTrades(authController.accessToken.value, authController.authModel.login);
              },
              child: Column(
                children: [
